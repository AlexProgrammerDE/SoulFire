...
public class Shulker extends Mob {
  ...
  public Direction getAttachFace() {
    return Direction.fromMCPLDirection(this.metadataState.getMetadata(NamedEntityData.SHULKER__ATTACH_FACE, MetadataTypes.DIRECTION));
  }
  ...
  private int getRawPeekAmount() {
    return this.metadataState.getMetadata(NamedEntityData.SHULKER__PEEK, MetadataTypes.INT);
  }
}

...
public record NamedEntityData(String key, int networkId, String entityClass) {
  ...
  public static final NamedEntityData AGEABLE_MOB__BABY_ID = register("baby_id", 16, "ageable_mob");
  ...
  public static final NamedEntityData BEE__FLAGS_ID = register("flags_id", 17, "bee");
  public static final NamedEntityData BEE__REMAINING_ANGER_TIME = register("remaining_anger_time", 18, "bee");
  public static final NamedEntityData BLAZE__FLAGS_ID = register("flags_id", 16, "blaze");
  public static final NamedEntityData BLOCK_DISPLAY__BLOCK_STATE_ID = register("block_state_id", 23, "block_display");
  ...
  public static final NamedEntityData CAT__VARIANT_ID = register("variant_id", 19, "cat");
  ...
  public static final NamedEntityData DISPLAY__BILLBOARD_RENDER_CONSTRAINTS_ID = register("billboard_render_constraints_id", 15, "display");
  public static final NamedEntityData DISPLAY__BRIGHTNESS_OVERRIDE_ID = register("brightness_override_id", 16, "display");
  public static final NamedEntityData DISPLAY__GLOW_COLOR_OVERRIDE_ID = register("glow_color_override_id", 22, "display");
  public static final NamedEntityData DISPLAY__HEIGHT_ID = register("height_id", 21, "display");
  public static final NamedEntityData DISPLAY__LEFT_ROTATION_ID = register("left_rotation_id", 13, "display");
  public static final NamedEntityData DISPLAY__POS_ROT_INTERPOLATION_DURATION_ID = register("pos_rot_interpolation_duration_id", 10, "display");
  public static final NamedEntityData DISPLAY__RIGHT_ROTATION_ID = register("right_rotation_id", 14, "display");
  public static final NamedEntityData DISPLAY__SCALE_ID = register("scale_id", 12, "display");
  public static final NamedEntityData DISPLAY__SHADOW_RADIUS_ID = register("shadow_radius_id", 18, "display");
  public static final NamedEntityData DISPLAY__SHADOW_STRENGTH_ID = register("shadow_strength_id", 19, "display");
  public static final NamedEntityData DISPLAY__TRANSFORMATION_INTERPOLATION_DURATION_ID = register("transformation_interpolation_duration_id", 9, "display");
  public static final NamedEntityData DISPLAY__TRANSFORMATION_INTERPOLATION_START_DELTA_TICKS_ID = register("transformation_interpolation_start_delta_ticks_id", 8, "display");
  public static final NamedEntityData DISPLAY__TRANSLATION_ID = register("translation_id", 11, "display");
  public static final NamedEntityData DISPLAY__VIEW_RANGE_ID = register("view_range_id", 17, "display");
  public static final NamedEntityData DISPLAY__WIDTH_ID = register("width_id", 20, "display");
  ...
  public static final NamedEntityData ENTITY__AIR_SUPPLY_ID = register("air_supply_id", 1, "entity");
  ...
  public static final NamedEntityData ENTITY__SHARED_FLAGS_ID = register("shared_flags_id", 0, "entity");
  ...
  public static final NamedEntityData FOX__FLAGS_ID = register("flags_id", 18, "fox");
  ...
  public static final NamedEntityData FOX__TYPE_ID = register("type_id", 17, "fox");
  public static final NamedEntityData FROG__TONGUE_TARGET_ID = register("tongue_target_id", 18, "frog");
  public static final NamedEntityData FROG__VARIANT_ID = register("variant_id", 17, "frog");
  ...
  public static final NamedEntityData INTERACTION__HEIGHT_ID = register("height_id", 9, "interaction");
  public static final NamedEntityData INTERACTION__RESPONSE_ID = register("response_id", 10, "interaction");
  public static final NamedEntityData INTERACTION__WIDTH_ID = register("width_id", 8, "interaction");
  public static final NamedEntityData IRON_GOLEM__FLAGS_ID = register("flags_id", 16, "iron_golem");
  public static final NamedEntityData ITEM_DISPLAY__ITEM_DISPLAY_ID = register("item_display_id", 24, "item_display");
  public static final NamedEntityData ITEM_DISPLAY__ITEM_STACK_ID = register("item_stack_id", 23, "item_display");
  ...
  public static final NamedEntityData LIVING_ENTITY__ARROW_COUNT_ID = register("arrow_count_id", 12, "living_entity");
  public static final NamedEntityData LIVING_ENTITY__EFFECT_AMBIENCE_ID = register("effect_ambience_id", 11, "living_entity");
  public static final NamedEntityData LIVING_ENTITY__EFFECT_PARTICLES = register("effect_particles", 10, "living_entity");
  public static final NamedEntityData LIVING_ENTITY__HEALTH_ID = register("health_id", 9, "living_entity");
  public static final NamedEntityData LIVING_ENTITY__LIVING_ENTITY_FLAGS = register("living_entity_flags", 8, "living_entity");
  public static final NamedEntityData LIVING_ENTITY__SLEEPING_POS_ID = register("sleeping_pos_id", 14, "living_entity");
  public static final NamedEntityData LIVING_ENTITY__STINGER_COUNT_ID = register("stinger_count_id", 13, "living_entity");
  public static final NamedEntityData LLAMA__STRENGTH_ID = register("strength_id", 19, "llama");
  public static final NamedEntityData LLAMA__VARIANT_ID = register("variant_id", 20, "llama");
  ...
  public static final NamedEntityData MOB__MOB_FLAGS_ID = register("mob_flags_id", 15, "mob");
  ...
  public static final NamedEntityData PAINTING__PAINTING_VARIANT_ID = register("painting_variant_id", 8, "painting");
  public static final NamedEntityData PANDA__EAT_COUNTER = register("eat_counter", 19, "panda");
  public static final NamedEntityData PANDA__HIDDEN_GENE_ID = register("hidden_gene_id", 21, "panda");
  public static final NamedEntityData PANDA__ID_FLAGS = register("id_flags", 22, "panda");
  public static final NamedEntityData PANDA__MAIN_GENE_ID = register("main_gene_id", 20, "panda");
  ...
  public static final NamedEntityData PARROT__VARIANT_ID = register("variant_id", 19, "parrot");
  public static final NamedEntityData PHANTOM__ID_SIZE = register("id_size", 16, "phantom");
  public static final NamedEntityData PIGLIN__BABY_ID = register("baby_id", 17, "piglin");
  ...
  public static final NamedEntityData PIG__SADDLE_ID = register("saddle_id", 17, "pig");
  public static final NamedEntityData PILLAGER__IS_CHARGING_CROSSBOW = register("is_charging_crossbow", 17, "pillager");
  public static final NamedEntityData PLAYER__PLAYER_ABSORPTION_ID = register("player_absorption_id", 15, "player");
  ...
  public static final NamedEntityData PLAYER__SCORE_ID = register("score_id", 16, "player");
  ...
  public static final NamedEntityData POLAR_BEAR__STANDING_ID = register("standing_id", 17, "polar_bear");
  public static final NamedEntityData PRIMED_TNT__BLOCK_STATE_ID = register("block_state_id", 9, "primed_tnt");
  public static final NamedEntityData PRIMED_TNT__FUSE_ID = register("fuse_id", 8, "primed_tnt");
  public static final NamedEntityData PUFFERFISH__PUFF_STATE = register("puff_state", 17, "pufferfish");
  public static final NamedEntityData RABBIT__TYPE_ID = register("type_id", 17, "rabbit");
  ...
  public static final NamedEntityData SHEEP__WOOL_ID = register("wool_id", 17, "sheep");
  public static final NamedEntityData SHULKER__ATTACH_FACE_ID = register("attach_face_id", 16, "shulker");
  public static final NamedEntityData SHULKER__COLOR_ID = register("color_id", 18, "shulker");
  public static final NamedEntityData SHULKER__PEEK_ID = register("peek_id", 17, "shulker");
  public static final NamedEntityData SKELETON__STRAY_CONVERSION_ID = register("stray_conversion_id", 16, "skeleton");
  ...
  public static final NamedEntityData SNOW_GOLEM__PUMPKIN_ID = register("pumpkin_id", 16, "snow_golem");
  public static final NamedEntityData SPELLCASTER_ILLAGER__SPELL_CASTING_ID = register("spell_casting_id", 17, "spellcaster_illager");
  public static final NamedEntityData SPIDER__FLAGS_ID = register("flags_id", 16, "spider");
  public static final NamedEntityData STRIDER__BOOST_TIME = register("boost_time", 17, "strider");
  public static final NamedEntityData STRIDER__SADDLE_ID = register("saddle_id", 19, "strider");
  public static final NamedEntityData STRIDER__SUFFOCATING = register("suffocating", 18, "strider");
  public static final NamedEntityData TAMABLE_ANIMAL__FLAGS_ID = register("flags_id", 17, "tamable_animal");
  public static final NamedEntityData TAMABLE_ANIMAL__OWNERUUID_ID = register("owneruuid_id", 18, "tamable_animal");
  public static final NamedEntityData TEXT_DISPLAY__BACKGROUND_COLOR_ID = register("background_color_id", 25, "text_display");
  public static final NamedEntityData TEXT_DISPLAY__LINE_WIDTH_ID = register("line_width_id", 24, "text_display");
  public static final NamedEntityData TEXT_DISPLAY__STYLE_FLAGS_ID = register("style_flags_id", 27, "text_display");
  public static final NamedEntityData TEXT_DISPLAY__TEXT_ID = register("text_id", 23, "text_display");
  public static final NamedEntityData TEXT_DISPLAY__TEXT_OPACITY_ID = register("text_opacity_id", 26, "text_display");
  ...
  public static final NamedEntityData VEX__FLAGS_ID = register("flags_id", 16, "vex");
  ...
  public static final NamedEntityData WOLF__INTERESTED_ID = register("interested_id", 19, "wolf");
  public static final NamedEntityData WOLF__REMAINING_ANGER_TIME = register("remaining_anger_time", 21, "wolf");
  public static final NamedEntityData WOLF__VARIANT_ID = register("variant_id", 22, "wolf");
  public static final NamedEntityData ZOGLIN__BABY_ID = register("baby_id", 16, "zoglin");
  public static final NamedEntityData ZOMBIE_VILLAGER__CONVERTING_ID = register("converting_id", 19, "zombie_villager");
  public static final NamedEntityData ZOMBIE_VILLAGER__VILLAGER_DATA = register("villager_data", 20, "zombie_villager");
  public static final NamedEntityData ZOMBIE__BABY_ID = register("baby_id", 16, "zombie");
  public static final NamedEntityData ZOMBIE__DROWNED_CONVERSION_ID = register("drowned_conversion_id", 18, "zombie");

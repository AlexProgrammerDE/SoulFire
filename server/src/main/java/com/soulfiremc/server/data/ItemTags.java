...
public class ItemTags {
  ...
  public static final ResourceKey MEAT = register("minecraft:meat");
  ...
  public static final ResourceKey COW_FOOD = register("minecraft:cow_food");
  public static final ResourceKey GOAT_FOOD = register("minecraft:goat_food");
  public static final ResourceKey SHEEP_FOOD = register("minecraft:sheep_food");
  public static final ResourceKey WOLF_FOOD = register("minecraft:wolf_food");
  public static final ResourceKey CAT_FOOD = register("minecraft:cat_food");
  public static final ResourceKey HORSE_FOOD = register("minecraft:horse_food");
  public static final ResourceKey HORSE_TEMPT_ITEMS = register("minecraft:horse_tempt_items");
  public static final ResourceKey CAMEL_FOOD = register("minecraft:camel_food");
  public static final ResourceKey ARMADILLO_FOOD = register("minecraft:armadillo_food");
  public static final ResourceKey BEE_FOOD = register("minecraft:bee_food");
  public static final ResourceKey CHICKEN_FOOD = register("minecraft:chicken_food");
  public static final ResourceKey FROG_FOOD = register("minecraft:frog_food");
  public static final ResourceKey HOGLIN_FOOD = register("minecraft:hoglin_food");
  public static final ResourceKey LLAMA_FOOD = register("minecraft:llama_food");
  public static final ResourceKey LLAMA_TEMPT_ITEMS = register("minecraft:llama_tempt_items");
  public static final ResourceKey OCELOT_FOOD = register("minecraft:ocelot_food");
  public static final ResourceKey PANDA_FOOD = register("minecraft:panda_food");
  public static final ResourceKey PIG_FOOD = register("minecraft:pig_food");
  public static final ResourceKey RABBIT_FOOD = register("minecraft:rabbit_food");
  public static final ResourceKey STRIDER_FOOD = register("minecraft:strider_food");
  public static final ResourceKey STRIDER_TEMPT_ITEMS = register("minecraft:strider_tempt_items");
  public static final ResourceKey TURTLE_FOOD = register("minecraft:turtle_food");
  public static final ResourceKey PARROT_FOOD = register("minecraft:parrot_food");
  public static final ResourceKey PARROT_POISONOUS_FOOD = register("minecraft:parrot_poisonous_food");
  public static final ResourceKey AXOLOTL_FOOD = register("minecraft:axolotl_food");
  ...
  public static final ResourceKey FOOT_ARMOR = register("minecraft:foot_armor");
  public static final ResourceKey LEG_ARMOR = register("minecraft:leg_armor");
  public static final ResourceKey CHEST_ARMOR = register("minecraft:chest_armor");
  public static final ResourceKey HEAD_ARMOR = register("minecraft:head_armor");
  public static final ResourceKey SKULLS = register("minecraft:skulls");
  ...
  public static final ResourceKey DYEABLE = register("minecraft:dyeable");
  public static final ResourceKey ENCHANTABLE_WITH_FOOT_ARMOR = register("minecraft:enchantable/foot_armor");
  public static final ResourceKey ENCHANTABLE_WITH_LEG_ARMOR = register("minecraft:enchantable/leg_armor");
  public static final ResourceKey ENCHANTABLE_WITH_CHEST_ARMOR = register("minecraft:enchantable/chest_armor");
  public static final ResourceKey ENCHANTABLE_WITH_HEAD_ARMOR = register("minecraft:enchantable/head_armor");
  public static final ResourceKey ENCHANTABLE_WITH_ARMOR = register("minecraft:enchantable/armor");
  public static final ResourceKey ENCHANTABLE_WITH_SWORD = register("minecraft:enchantable/sword");
  public static final ResourceKey ENCHANTABLE_WITH_FIRE_ASPECT = register("minecraft:enchantable/fire_aspect");
  public static final ResourceKey ENCHANTABLE_WITH_SHARP_WEAPON = register("minecraft:enchantable/sharp_weapon");
  public static final ResourceKey ENCHANTABLE_WITH_WEAPON = register("minecraft:enchantable/weapon");
  public static final ResourceKey ENCHANTABLE_WITH_MINING = register("minecraft:enchantable/mining");
  public static final ResourceKey ENCHANTABLE_WITH_MINING_LOOT = register("minecraft:enchantable/mining_loot");
  public static final ResourceKey ENCHANTABLE_WITH_FISHING = register("minecraft:enchantable/fishing");
  public static final ResourceKey ENCHANTABLE_WITH_TRIDENT = register("minecraft:enchantable/trident");
  public static final ResourceKey ENCHANTABLE_WITH_DURABILITY = register("minecraft:enchantable/durability");
  public static final ResourceKey ENCHANTABLE_WITH_BOW = register("minecraft:enchantable/bow");
  public static final ResourceKey ENCHANTABLE_WITH_EQUIPPABLE = register("minecraft:enchantable/equippable");
  public static final ResourceKey ENCHANTABLE_WITH_CROSSBOW = register("minecraft:enchantable/crossbow");
  public static final ResourceKey ENCHANTABLE_WITH_VANISHING = register("minecraft:enchantable/vanishing");
  public static final ResourceKey ENCHANTABLE_WITH_MACE = register("minecraft:enchantable/mace");
  //@formatter:on

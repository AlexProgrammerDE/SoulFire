...
public record AttributeType(int id, Key key, double min, double max, double defaultValue) implements RegistryValue<AttributeType> {
  ...
  public static final AttributeType GENERIC_BURNING_TIME = register("minecraft:generic.burning_time");
  public static final AttributeType GENERIC_EXPLOSION_KNOCKBACK_RESISTANCE = register("minecraft:generic.explosion_knockback_resistance");
  ...
  public static final AttributeType PLAYER_MINING_EFFICIENCY = register("minecraft:player.mining_efficiency");
  public static final AttributeType GENERIC_MOVEMENT_EFFICIENCY = register("minecraft:generic.movement_efficiency");
  public static final AttributeType GENERIC_MOVEMENT_SPEED = register("minecraft:generic.movement_speed");
  public static final AttributeType GENERIC_OXYGEN_BONUS = register("minecraft:generic.oxygen_bonus");
  ...
  public static final AttributeType PLAYER_SNEAKING_SPEED = register("minecraft:player.sneaking_speed");
  ...
  public static final AttributeType PLAYER_SUBMERGED_MINING_SPEED = register("minecraft:player.submerged_mining_speed");
  public static final AttributeType PLAYER_SWEEPING_DAMAGE_RATIO = register("minecraft:player.sweeping_damage_ratio");
  public static final AttributeType GENERIC_WATER_MOVEMENT_EFFICIENCY = register("minecraft:generic.water_movement_efficiency");
  //@formatter:on

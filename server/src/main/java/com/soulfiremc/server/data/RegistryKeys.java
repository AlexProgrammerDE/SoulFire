...
public final class RegistryKeys {
  ...
  public static final ResourceKey<?> DATA_COMPONENT_PREDICATE_TYPE = ResourceKey.key("minecraft:data_component_predicate_type");
  ...
  public static final ResourceKey<?> SPAWN_CONDITION_TYPE = ResourceKey.key("minecraft:spawn_condition_type");
  ...
  public static final ResourceKey<?> TEST_ENVIRONMENT_DEFINITION_TYPE = ResourceKey.key("minecraft:test_environment_definition_type");
  public static final ResourceKey<?> TEST_FUNCTION = ResourceKey.key("minecraft:test_function");
  public static final ResourceKey<?> TEST_INSTANCE_TYPE = ResourceKey.key("minecraft:test_instance_type");
  public static final ResourceKey<?> TICKET_TYPE = ResourceKey.key("minecraft:ticket_type");
  ...
  public static final ResourceKey<?> CHICKEN_VARIANT = ResourceKey.key("minecraft:chicken_variant");
  ...
  public static final ResourceKey<?> COW_VARIANT = ResourceKey.key("minecraft:cow_variant");
  ...
  public static final ResourceKey<?> PIG_VARIANT = ResourceKey.key("minecraft:pig_variant");
  ...
  public static final ResourceKey<?> TEST_ENVIRONMENT = ResourceKey.key("minecraft:test_environment");
  public static final ResourceKey<?> TEST_INSTANCE = ResourceKey.key("minecraft:test_instance");
  ...
  public static final ResourceKey<?> WOLF_SOUND_VARIANT = ResourceKey.key("minecraft:wolf_sound_variant");

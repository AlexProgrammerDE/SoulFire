...
public class Bot1_9 extends AbstractBot {
    ...
    public Bot1_9(Options options, IPacketWrapper account, InetSocketAddress address, Logger log, ServiceServer serviceServer, ProxyType proxyType, String username, String password) {
    ...
    public void connect(String host, int port) {
        ...
        session.addListener(new SessionListener1_9(bus));

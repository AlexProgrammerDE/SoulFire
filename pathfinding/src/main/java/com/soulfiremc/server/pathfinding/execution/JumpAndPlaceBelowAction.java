...
/// Represents a jump and place block below action.
/// The actual execution logic is implemented in the Minecraft-specific module.
public record JumpAndPlaceBelowAction(SFVec3i blockPosition, BlockPlaceAgainstData againstData) implements WorldAction {
  @Override

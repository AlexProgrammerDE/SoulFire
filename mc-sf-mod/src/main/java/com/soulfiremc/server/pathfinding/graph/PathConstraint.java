...
public class PathConstraint {
  ...
  public boolean isOutOfLevel(BlockState blockState, BlockPos pos) {
    return blockState.blockType() == Block.VOID_AIR && !levelHeightAccessor.isOutsideBuildHeight(pos.y);
  }

  public boolean canBreakBlockPos(BlockPos pos) {
  ...
  private List<EntityRangeData> getUnfriendlyEntitiesExpensive() {
    ...
    return entity.level().getEntities()
      ...
      .map(e -> new EntityRangeData(
        ...
        BlockPos.fromInt(e.blockPosition())
      ))
      .toList();
  }

  private record EntityRangeData(double followRange, BlockPos entityPosition) {}
}

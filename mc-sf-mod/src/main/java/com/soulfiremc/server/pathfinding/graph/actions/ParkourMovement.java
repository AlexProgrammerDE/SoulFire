...
public final class ParkourMovement extends GraphAction implements Cloneable {
  ...
  public enum ParkourDirection {
    NORTH(new BlockPos(0, 0, -1), ActionDirection.NORTH),
    SOUTH(new BlockPos(0, 0, 1), ActionDirection.SOUTH),
    EAST(new BlockPos(1, 0, 0), ActionDirection.EAST),
    WEST(new BlockPos(-1, 0, 0), ActionDirection.WEST);
  ...
  private record MovementFreeSubscription() implements ParkourMovementSubscription {
    ...
    @Override
    public MinecraftGraph.SubscriptionSingleResult processBlock(MinecraftGraph graph, BlockPos key, ParkourMovement parkourMovement,

 ...
 */
public record NodeState(BlockPos blockPosition, int usableBlockItems) {
  public static NodeState forInfo(BlockPos blockPosition, ProjectedInventory inventory) {

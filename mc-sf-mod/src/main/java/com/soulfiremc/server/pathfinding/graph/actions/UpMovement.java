...
public final class UpMovement extends GraphAction implements Cloneable {
  ...
  private record MovementFreeSubscription(int blockArrayIndex, Direction blockBreakSideHint) implements UpMovementSubscription {
    @Override
    public MinecraftGraph.SubscriptionSingleResult processBlock(MinecraftGraph graph, BlockPos key, UpMovement upMovement,

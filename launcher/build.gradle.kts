...
dependencies {
  ...
  api("com.nimbusds:oauth2-oidc-sdk:11.18")
  ...
  api("org.lwjgl:lwjgl-freetype:3.3.3")
  api("org.lwjgl:lwjgl-glfw:3.3.3")
  api("org.lwjgl:lwjgl-jemalloc:3.3.3")
  ...
  api("io.github.llamalad7:mixinextras-fabric:0.5.0-rc.2")

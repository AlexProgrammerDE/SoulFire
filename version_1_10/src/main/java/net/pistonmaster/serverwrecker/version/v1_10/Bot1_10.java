package net.pistonmaster.serverwrecker.version.v1_10;
...
public class Bot1_10 extends AbstractBot {
    ...
    public Bot1_10(Options options, IPacketWrapper account, InetSocketAddress address, Logger log, ServiceServer serviceServer, ProxyType proxyType, String username, String password) {

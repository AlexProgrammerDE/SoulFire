...
public sealed interface Property permits SingleProperty, MinMaxPropertyLink {
  ...
  record Builder(String namespace) {
    ...
    public <T extends Enum<T>> ComboProperty ofEnumMapped(String key, String uiName, String[] cliFlags, String description, T[] values,
                                                          T defaultValue, Function<T, String> mapper) {
      return new ComboProperty(namespace, key, uiName, cliFlags, description, ComboProperty.ComboOption.fromEnum(values, mapper),

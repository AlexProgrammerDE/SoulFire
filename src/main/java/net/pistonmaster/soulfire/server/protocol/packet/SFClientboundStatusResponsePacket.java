...
@With
@AllArgsConstructor
public class SFClientboundStatusResponsePacket implements MinecraftPacket {
    private static final Gson GSON = new Gson();
    private final @NonNull JsonObject info;

    public SFClientboundStatusResponsePacket(ByteBuf in, MinecraftCodecHelper helper) {

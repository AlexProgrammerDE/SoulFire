...
public record MovementAction(BlockPosition position) implements Action {
    @Override
    public boolean isCompleted(BotConnection connection) {
        ...
        double distanceToGoal = botPosition.distance(position.position());
    ...
    public void tick(BotConnection connection) {
        ...
        movementManager.lookAt(RotationOrigin.EYES, position.position());
        ...
        if (position.position().getY() > botPosition.getY()) {

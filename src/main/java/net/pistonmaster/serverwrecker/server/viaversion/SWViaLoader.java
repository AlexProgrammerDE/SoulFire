...
import net.pistonmaster.serverwrecker.server.viaversion.providers.SWViaCompressionProvider;
import net.pistonmaster.serverwrecker.server.viaversion.providers.SWViaEncryptionProvider;
import net.pistonmaster.serverwrecker.server.viaversion.providers.SWViaGameProfileFetcher;
import net.pistonmaster.serverwrecker.server.viaversion.providers.SWViaNettyPipelineProvider;
import net.pistonmaster.serverwrecker.server.viaversion.providers.SWViaOldAuthProvider;
import net.pistonmaster.serverwrecker.server.viaversion.providers.SWViaVersionProvider;

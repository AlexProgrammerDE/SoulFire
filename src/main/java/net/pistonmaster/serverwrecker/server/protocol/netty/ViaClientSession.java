...
import net.pistonmaster.serverwrecker.server.protocol.BotConnectionMeta;
import net.pistonmaster.serverwrecker.server.protocol.SWProtocolConstants;
...
import net.pistonmaster.serverwrecker.server.viaversion.FrameCodec;

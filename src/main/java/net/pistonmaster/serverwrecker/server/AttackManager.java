...
import net.pistonmaster.serverwrecker.server.protocol.BotConnectionFactory;
...
import net.pistonmaster.serverwrecker.server.settings.AccountSettings;
import net.pistonmaster.serverwrecker.server.settings.BotSettings;
import net.pistonmaster.serverwrecker.server.settings.ProxySettings;

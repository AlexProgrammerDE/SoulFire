...
public class WindowContainer extends Container {
    /**
     * The slots a normal player inventory on the bottom of a window has.
     * 27 slots for the main inventory and 9 slots for the hotbar.
     */
    ...
    public WindowContainer(ContainerType containerType, Component title, int id) {
        super(switch (containerType) {
            ...
            case ANVIL, CARTOGRAPHY, FURNACE, BLAST_FURNACE,
                    GRINDSTONE, MERCHANT, LEGACY_SMITHING,

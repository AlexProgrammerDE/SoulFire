...
dependencies {
    ...
    implementation("com.viaversion:viaversion:4.8.0-23w33a-SNAPSHOT") { isTransitive = false }
    implementation("com.viaversion:viabackwards:4.8.0-23w33a-SNAPSHOT") { isTransitive = false }

...
public class CommandLineParser {
    ...
    static ParseResult parse(String[] args) throws ParseException {
        ...
        return new ParseResult(
                cli.shouldPrintHelp(),
                new net.pistonmaster.wirebot.common.Options(
                        cli.getHostname(),
                        cli.getPort(),
                        cli.getAmount(),
                        cli.getJoinDelayMs(),
    ...
    static void printHelp() {
        ...
        formatter.printHelp(WireBot.PROJECT_NAME, new CommandLineParser().options);
    }
    ...
    static class ParseResult {
        ...
        final net.pistonmaster.wirebot.common.Options options;

        ParseResult(boolean showHelp, net.pistonmaster.wirebot.common.Options options) {

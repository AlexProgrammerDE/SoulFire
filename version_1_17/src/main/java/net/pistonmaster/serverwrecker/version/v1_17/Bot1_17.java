...
public class Bot1_17 extends AbstractBot {
    ...
    public Bot1_17(Options options, IPacketWrapper account, InetSocketAddress address, ServiceServer serviceServer, ProxyType proxyType, String username, String password) {

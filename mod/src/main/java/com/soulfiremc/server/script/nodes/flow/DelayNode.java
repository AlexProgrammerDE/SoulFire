...
/// Flow control node that provides advanced delay with random jitter support.
public final class DelayNode extends AbstractScriptNode {
  private static final NodeMetadata METADATA = NodeMetadata.builder()
    ...
    .addInputs(
      ...
      PortDefinition.inputWithDefault("baseMs", "Base (ms)", PortType.NUMBER, "1000", "Base delay in milliseconds"),
      PortDefinition.inputWithDefault("jitterMs", "Jitter (ms)", PortType.NUMBER, "0", "Random jitter ± this value"),
    ...
    .description("Advanced delay with random jitter support")
    .icon("timer")
    .color("#8B5CF6")
    .addKeywords("delay", "wait", "sleep", "pause", "jitter", "random")
    .build();

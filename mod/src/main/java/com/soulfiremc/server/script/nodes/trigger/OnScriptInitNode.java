...
public final class OnScriptInitNode extends AbstractScriptNode {
  public static final NodeMetadata METADATA = NodeMetadata.builder()
    ...
    .addOutputs(
      ...
      PortDefinition.output("timestamp", "Timestamp", PortType.NUMBER, "The timestamp when the script was initialized")
    )
    .isTrigger(true)
    .description("Fires once when the script is started")
    .icon("play")
    .color("#2196F3")

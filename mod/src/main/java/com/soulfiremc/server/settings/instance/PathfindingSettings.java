...
public final class PathfindingSettings implements SettingsObject {
  ...
  public static final BooleanProperty ALLOW_BREAKING_UNDIGGABLE =
    ImmutableBooleanProperty.builder()
      ...
      .defaultValue(false)
      .build();
  public static final BooleanProperty AVOID_DIAGONAL_SQUEEZE =
    ImmutableBooleanProperty.builder()
      .namespace(NAMESPACE)
      ...
      .defaultValue(false)
      .build();
  public static final BooleanProperty AVOID_HARMFUL_ENTITIES =
    ImmutableBooleanProperty.builder()
      .namespace(NAMESPACE)
      ...
      .defaultValue(true)
      .build();
  public static final IntProperty MAX_ENEMY_PENALTY =
    ImmutableIntProperty.builder()
      ...
      .build();
  public static final IntProperty BREAK_BLOCK_PENALTY =
    ImmutableIntProperty.builder()
      .namespace(NAMESPACE)
      ...
      .maxValue(Integer.MAX_VALUE)
      .build();
  public static final IntProperty PLACE_BLOCK_PENALTY =
    ImmutableIntProperty.builder()
      .namespace(NAMESPACE)
      ...
      .maxValue(Integer.MAX_VALUE)
      .build();
  public static final IntProperty EXPIRE_TIMEOUT =
    ImmutableIntProperty.builder()
      .namespace(NAMESPACE)
      .key("expire-timeout")
      ...
      .maxValue(Integer.MAX_VALUE)
      .build();
  public static final BooleanProperty DISABLE_PRUNING =
    ImmutableBooleanProperty.builder()
      .namespace(NAMESPACE)
      .key("disable-pruning")

...
public class Bot1_8 extends AbstractBot {
    ...
    public Bot1_8(Options options, IPacketWrapper account, InetSocketAddress address, ServiceServer serviceServer, ProxyType proxyType, String username, String password, Logger logger) {
    ...
    public void connect(String host, int port) {
        ...
        session.addListener(new SessionListener1_8(bus, account));

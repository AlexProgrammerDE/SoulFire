...
public class Bot1_7 extends AbstractBot {
    ...
    public Bot1_7(Options options, IPacketWrapper account, InetSocketAddress address, ServiceServer serviceServer, ProxyType proxyType, String username, String password) {
